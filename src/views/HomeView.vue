<template>
    <!-- Hero image with Contact Us Today CTA button -->
    <header class="w-100 h-96 bg-[url('hero-image.jpeg')] bg-cover bg-center flex justify-center items-center">
        <div class="flex flex-col justify-center items-center">
            <h1 class="text-center text-5xl text-white font-bold drop-shadow-lg">Looking for Reliable and Trustworthy Home Tutors?</h1>
            <p class="mt-5 text-center text-lg text-white opacity-70 mb-4">We have over 100 dedicated home tutors to help your child ace their work!</p>
            <RouterLink to="/contact-us" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-4 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                href="#">Contact Us Today!</RouterLink>
        </div>
    </header>
